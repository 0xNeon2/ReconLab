...
import { Search, Play, Square, Download, AlertCircle } from 'lucide-react';
    ...
    try {
      const response = await fetch('http://localhost:8000/api/run-tool', {
        ...
        body: JSON.stringify({
          tool: 'ffuf',
          target: url,
          command: `ffuf -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -u ${url}/FUZZ`
        }),
      });
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400">Discover hidden directories and endpoints using ffuf</p>
        </div>
      </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              Running: <code className="bg-dark-700 px-2 py-1 rounded text-primary font-mono">
                ffuf -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -u {url || 'URL'}/FUZZ
              </code>
            </p>
          </div>
        </div>
